...
class RefferalVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.referralView.viewReferralCode.addDashedBorderLayer()
    }
...
extension RefferalVC {
    func getReferralDetails() {
        if ConnectionCheck.isConnectedToNetwork() {
            ...
            let url = APIHelper.shared.BASEURL + APIHelper.getReferral
                ...
                case .success(_):
                    ...
                    if let result = response.result.value as? [String: AnyObject] {
                        if let data = result["data"] as? [String: AnyObject] {
                            ...
                            if let referAmount = data["refer_by_driver_amount"] {
