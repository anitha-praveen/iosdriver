...
class PageVC: UIPageViewController {
     ...
     */
    let pages:[UIViewController] = [OnboardScreenVC("img_onboard_one", hint: "txt_veh_selection".localize(), desc:       "veh_sel_driver_desc".localize() , pageIndex: 0),
                                    OnboardScreenVC("img_onboard_two", hint: "txt_live_tracking".localize(), desc: "live_ride_driver_desc".localize() , pageIndex: 1)]
    ...
    override func viewDidLoad() {
        ...
        self.firstPageWidth = firstPageIndicator.widthAnchor.constraint(equalToConstant: 35)
