...
class UpdateAppView: UIView {
    ...
    func setupViews(Base baseView: UIView) {
        ...
        imgAppLogo.image = UIImage(named: "Logo_Appname")
        ...
        lblUpdateReq.text = "App Update Required".localize()
        ...
        lblDescription.text = "Please Update your App for Better Experience"
        lblDescription.textAlignment = .center
        lblDescription.textColor = .secondaryColor
        lblDescription.numberOfLines = 0
        lblDescription.lineBreakMode = .byWordWrapping
        lblDescription.font = .appRegularFont(ofSize: 16)
