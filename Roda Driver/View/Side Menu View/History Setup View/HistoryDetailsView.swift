...
class HistoryDetailsView: UIView {
    ...
    let distanceDetailView = ShimmerView()
    ...
    func setupViews(Base baseView: UIView) {
       ...
       // addressView.addShadow()
        ...
        driverDetailView.clipsToBounds = true
        driverDetailView.backgroundColor = .hexToColor("ffffff")
        ...
        distanceDetailView.clipsToBounds = true
        ...
        baseView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[titleView]-10-[scrollview]", options: [], metrics: nil, views: layoutDict))
        ...
        containerView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(15)-[addressView]-8-[driverDetailView]-8-[distanceDetailView]-8-[stackOutstation]-15-|", options: [], metrics: nil, views: layoutDict))
        ...
        driverDetailView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-12-[vehicleImageView(30)]-5-[lblVehicleTypeName(20)]-5-[lblVehicleNumber(20)]-12-|", options: [], metrics: nil, views: layoutDict))
