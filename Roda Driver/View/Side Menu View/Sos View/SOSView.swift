...
class SOSView: UIView {
    ...
    func setupViews(Base baseView: UIView) {
        ...
        sosheadinglbl.font = UIFont.appBoldFont(ofSize: 26)
        ...
        sosDetailSubmitBtn.setTitleColor(.secondaryColor, for: .normal)
        ...
        baseView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[backBtn(30)]-5-[lineBar(1)]-15-[sosheadinglbl(30)]-(15)-[soshintlbl]-(25)-[soslisttbv]", options: [], metrics: nil, views: layoutDict))
...
class SOSListTableViewCell: UITableViewCell {
    ...
    func setUpViews() {
        ...
        soscallBtn.setImage(UIImage(named: "callSos")?.withRenderingMode(.alwaysTemplate), for: .normal)
