...
//    }()
    ...
    public func show(message msg: String? = nil) {
        ...
        containerView.backgroundColor = UIColor.txtColor.withAlphaComponent(0.3)
        
        let logoImgView: UIImageView = {

            guard let gifImage = try? UIImage(gifName: "VdgG.gif") else {
                return UIImageView()
            }
        ...
        containerView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[logoImgView(60)]-10-[messageLbl]", options: [], metrics: nil, views: ["messageLbl":messageLbl,"logoImgView":logoImgView]))
        ...
        logoImgView.widthAnchor.constraint(equalToConstant: 60).isActive = true
